...
{list.length === 0 && (
<div style={{ border: '1px dashed #C4B79C', padding: '2rem', color: '#6E6552' }}>
...
return (
<a key={s.id} href={`/collections/${s.id}`} style={{ display: 'block', background: '#F2EDE0', border: '0.5px solid #C4B79C', borderRadius: '6px', padding: '0.85rem 1rem', marginBottom: '0.6rem', textDecoration: 'none' }}>
