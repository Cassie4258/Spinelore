...
return (
<div>
<h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', fontWeight: 500, fontSize: '1.8rem', color: '#e8dcc0', margin: '0 0 0.35rem' }}>Sets &amp; Series</h2>
<p style={{ color: '#8a7a5c', fontSize: '0.85rem', margin: '0 0 1.5rem' }}>Multi-volume sets, author series, and publisher's series in the archive</p>
{list.length === 0 && (
...
<div style={{ fontSize: '0.65rem', color: '#8a7a5c', letterSpacing: '0.1em', marginBottom: '0.15rem' }}>{(KIND_LABEL[s.kind] ?? 'Grouping').toUpperCase()}</div>
